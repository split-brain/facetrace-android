package org.splitbrain.facetrace;
...
import org.splitbrain.facetrace.R;
...
public class SplashActivity extends Activity {
    ...
    public void proceed() {
        startActivity(new Intent("org.splitbrain.facetrace.MAIN"));
        finish();
    }
    ...
    public void loadClojure() {
        new Thread(new Runnable(){
                ...
                public void run() {
                    ...
                    try {
                        Class.forName("org.splitbrain.facetrace.FacetraceActivity");
                    } catch (ClassNotFoundException e) {
                        Log.e(TAG, "Failed loading FacetraceActivity", e);
                    }
